...
Why bother thinking in terms of dynamical systems? From one perspective, this is a surprising if not silly question. Cognitive systems are dynamical systems, so why not avail ourselves of this incredibly successful framework that has been applied all over the place! Arguably, dynamical systems theory (DST) has already been widely successful in motor control, including in speech. Extending it to higher levels of analysis, such as lexical or discourse levels, is a natural next step in understanding complex cognition in terms of dynamical systems. Recurrence does this for us. It provides a kind of lense through which we can talk about how a system tends to change in time: Is it highly regular, or disordered? How often does a cognitive system revisit sequences of behaviors? How do these sequences of behaviors relate to sequences in other cognitive agents?
